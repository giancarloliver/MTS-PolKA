...
if __name__ == "__main__":
    ...
    cmd = [
        # "iperf3 -c 10.0.2.2 -B 10.0.1.1 --cport 12345 -n %sM -p 5201"%(bwu*5),
        "iperf3 -c 10.0.2.2 -B 10.0.1.1 --cport 12345 -t 30 -b 10M -p 5201",
        "iperf3 -c 10.0.2.2 -B 10.0.1.1 --cport 12345 -t 30 -b 100M -p 5202",
        "iperf3 -c 10.0.2.2 -B 10.0.1.1 --cport 12345 -t 30 -b 1000M -p 5203"
        # "iperf3 -c 10.0.2.2 -B 10.0.1.1 --cport 12346 -n %sM -p 5202"%(bwu*3),
        # "iperf3 -c 10.0.2.2 -B 10.0.1.1 --cport 12347 -n %sM -p 5203"%(bwu*1)
    ]
    start_time = [
