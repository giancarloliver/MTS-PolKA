...
for path_idx, path in enumerate(paths):
    ignorar = 1
    arq = f"latency_test/data/run/{method}_{path}.log"
...
plt.ylim(0, 13000)  # Ajuste o limite superior para 13000
...
# Save and clear plot
output_file_path = Path(f'latency_test/result/latency_ecmp.pdf')
