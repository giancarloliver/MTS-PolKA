...
plt.axvline(x=300, color='orange', linestyle='--', linewidth=3)

# # Add text label for the vertical line at x=270
# plt.text(275, plt.ylim()[1] * 0.9, '275s', color='black', ha='center', fontsize=16)
...
# Save and clear plot
output_file_path = Path(f'result/fct_rps.pdf')
