...
def topology(remote_controller):
    ...
    try:
        for test_number in range(1, 11): 
            ...
            # Iniciando o iperf cliente para Perfil 0
            iperf_cmd_0 = f'iperf3 -c {h2.IP()} -M 128 -t 10 --verbose &> data/test4/run2/output_perfil0_{test_number}.txt'
            print(f"Executing: {iperf_cmd_0}")
            h1.cmd(iperf_cmd_0)
            time.sleep(10)
            ...
            # Iniciando o iperf cliente para Perfil 3
            iperf_cmd_3 = f'iperf3 -c {h2.IP()} -M 128 -t 10 --verbose &> data/test4/run2/output_perfil3_{test_number}.txt'
            print(f"Executing: {iperf_cmd_3}")
            h1.cmd(iperf_cmd_3)
            time.sleep(10)
