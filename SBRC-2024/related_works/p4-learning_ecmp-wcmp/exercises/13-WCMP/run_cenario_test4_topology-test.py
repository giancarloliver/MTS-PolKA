...
def run():
    ...
    # _thread.start_new_thread(generate_flows, (net, src, dst, lambda_rate, duration, flow_size_kb))
    ...
    h1 = net.get('h1')
    h4 = net.get('h4')
    elephant_flow_size_mb = 100  # Size of each elephant flow (in Megabytes)
    ...
    latency_interval_ms = 100  # Interval (in milliseconds) for latency monitoring
