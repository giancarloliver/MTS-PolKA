...
def topology(remote_controller):
    ...
    net.addLink(switches[1], edges[1], bw=BW)  

    for i in range(2, n_switches_C):
        net.addLink(switches[0], switches[i], bw=BW) 
        net.addLink(switches[1], switches[i], bw=BW) 
    ...
    arq_bwm = f"data/run/FCT-tmp.bwm"
